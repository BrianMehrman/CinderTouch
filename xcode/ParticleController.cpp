...
void ParticleController::addParticles(int amt, const Vec2i &mouseLoc, const Vec2f &mouseVel, const Color &color )
{
    for( int i=0; i<amt; i++ )
    {
        ...
        mParticles.push_back( Particle( loc, vel, color ) );
    }
}
